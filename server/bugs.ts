...
export interface Bug {
  id: string;
  name: string;
  /** Single status-line glyph (kept narrow, like item icons). */
  glyph: string;
  tier: BugTier;
...
/** Severity-ranked catalog (tuning is design-rpg-phase3 OQ-P3.3). */
export const BUGS: readonly Bug[] = [
  { id: "typo_gremlin", name: "typo gremlin", glyph: "\u{1F41B}", tier: 1, reward: 1 }, // 🐛
  { id: "off_by_one", name: "off-by-one", glyph: "\u{1FAB0}", tier: 1, reward: 1 }, // 🪰
  { id: "null_wraith", name: "null wraith", glyph: "\u{1F47B}", tier: 2, reward: 2 }, // 👻
  { id: "type_error", name: "type error", glyph: "\u{1F47E}", tier: 2, reward: 2 }, // 👾
  { id: "race_condition", name: "race condition", glyph: "\u{1F577}️", tier: 3, reward: 3 }, // 🕷️
  { id: "memory_leak", name: "memory leak", glyph: "\u{1F9A0}", tier: 3, reward: 3 }, // 🦠
  { id: "segfault_dragon", name: "segfault dragon", glyph: "\u{1F409}", tier: 4, reward: 5 }, // 🐉
] as const;
